...
extern "C" void AVX512_Packed_Math_Long_(const ZmmVal * a, const ZmmVal * b, ZmmVal result[5], uint32_t operationMask);
extern "C" void AVX512_Packed_Math_Short_(const ZmmVal * a, const ZmmVal * b, ZmmVal result[6]);
