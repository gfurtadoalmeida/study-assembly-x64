...
namespace Assembly {
	namespace AVX512 {
		namespace Packed {
			...
			__declspec(dllexport) void Math_Long(const ZmmVal* a, const ZmmVal* b, ZmmVal result[5], uint32_t operationMask);
			__declspec(dllexport) void Math_Short(const ZmmVal* a, const ZmmVal* b, ZmmVal result[6]);
