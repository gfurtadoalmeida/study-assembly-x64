...
namespace Assembly {
	namespace AVX {
		namespace Packed {
			...
			__declspec(dllexport) bool Find_Array_Byte_Max(const uint8_t * input, int arrayLength, uint8_t * result);
			__declspec(dllexport) bool Find_Array_Byte_Min(const uint8_t * input, int arrayLength, uint8_t * result);
